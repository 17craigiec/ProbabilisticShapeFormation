#ifndef PROBABILISTICSHAPEFORMATION_H
#define PROBABILISTICSHAPEFORMATION_H

#include <buzz/argos/buzz_loop_functions.h>
#include <argos3/core/utility/math/rng.h>

class CProbabilisticShapeFormation : public CBuzzLoopFunctions {

public:

   CProbabilisticShapeFormation() {}
   virtual ~CProbabilisticShapeFormation() {}
